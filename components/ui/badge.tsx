  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-transparent bg-red-500/10 text-red-400 shadow hover:bg-red-500/20',
        outline: 'text-white/60 border-white/20',
        success: 'border-transparent bg-primary/10 text-primary hover:bg-primary/20',
        escalated: 'border-transparent bg-amber-500/10 text-amber-400 hover:bg-amber-500/20',
      },
    },
    defaultVariants: {
      variant: 'default',
