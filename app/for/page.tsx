...
export const metadata: Metadata = {
  ...
  description:
    'Find CypAI tailored for your business type and location — car rental, barbershop, hotel, restaurant, clinic, gym, real estate, or law firm across all Cyprus cities.',
  keywords: [
