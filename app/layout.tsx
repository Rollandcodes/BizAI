...
export const metadata: Metadata = {
  ...
  description:
    'B2B SaaS platform for 24/7 customer service, lead capture, and recovery automation. Manage website chat, WhatsApp, CRM, and Paddle-based billing flows in one system.',
  keywords:
    'B2B SaaS automation, AI customer service, lead recovery automation, WhatsApp AI chatbot, CRM automation, Paddle SaaS billing, Cyprus business AI',
  openGraph: {
