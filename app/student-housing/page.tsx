        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            {[
              ...
              { flag: '🇳🇬', code: 'NG', name: 'Hausa' },
              { flag: '🇮�', code: 'IR', name: 'فارسی' },
            ].map((lang) => (
              <div key={lang.code}
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="relative rounded-2xl border-2 border-amber-500 bg-white p-8 shadow-xl">
              ...
              <ul className="mt-6 space-y-3">
                ...
                <li className="flex items-start gap-2 text-gray-600 text-sm"><span className="text-amber-500 font-bold">✓</span> Lead follow-up automation</li>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8">
              ...
              <ul className="mt-6 space-y-3">
                ...
                <li className="flex items-start gap-2 text-gray-600 text-sm"><span className="text-amber-500 font-bold">✓</span> Multi-property support</li>
