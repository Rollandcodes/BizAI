...
export const howToSetUpCypaiInYourBusinessABeginnerFriendlyGuide: BlogPost = {
  slug: 'how-to-set-up-cypai-in-your-business-a-beginner-friendly-guide',
  title: 'How to Set Up CypAI in Your Business: A Beginner-Friendly Step-by-Step Guide',
  excerpt:
    'A simple, non-technical guide that shows exactly how to set up CypAI, train it on your business, connect your website and WhatsApp, and start using every important feature without confusion.',
  publishedAt: '2026-03-15',
  readingMinutes: 14,
  sectionTitle: 'Beginner Setup Guide',
  keywords: [
    'how to set up CypAI',
    'CypAI beginner guide',
    'how to onboard CypAI',
    'AI chatbot setup for small business',
    'WhatsApp AI setup guide',
    'website chat widget guide',
  ],
  metaDescription:
    'Learn how to set up CypAI step by step in very simple language. This guide explains onboarding, website widget setup, WhatsApp, CRM, bookings, analytics, and daily use for non-technical business owners.',
  sections: [
    {
      heading: 'What CypAI actually does in simple words',
      paragraphs: [
    ...
    {
      heading: 'Step 1: Create your account and pick the right plan',
      paragraphs: [
    ...
    {
      heading: 'Step 2: Fill in your business information carefully',
      paragraphs: [
    ...
    {
      heading: 'Step 3: Train the AI using your real prices and real questions',
      paragraphs: [
    ...
    {
      heading: 'Step 4: Customize the widget so it feels like your business',
      paragraphs: [
    ...
    {
      heading: 'Step 5: Put CypAI on your website',
      paragraphs: [
    ...
    {
      heading: 'Step 6: Connect WhatsApp if your customers message you there',
      paragraphs: [
    ...
    {
      heading: 'What the dashboard is for',
      paragraphs: [
    ...
    {
      heading: 'How to use the Conversations tab',
      paragraphs: [
    ...
    {
      heading: 'How follow-ups help you recover missed money',
      paragraphs: [
    ...
    {
      heading: 'What analytics are trying to tell you',
      paragraphs: [
    ...
    {
      heading: 'How to onboard yourself without getting overwhelmed',
      paragraphs: [
    ...
    {
      heading: 'The simplest way to think about CypAI',
      paragraphs: [
  ...
  cta: {
    heading: 'Set up CypAI one step at a time',
    body:
      'Start your free trial, follow the onboarding wizard, and use CypAI like a friendly helper that works all day and all night for your business.',
